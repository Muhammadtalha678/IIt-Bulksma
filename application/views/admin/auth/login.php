...
<div class="container">
  <div class="row login-container animated fadeInUp">  
      ...
      <?php } ?>
      <?php echo form_open('/admin/Home/validate', ['class' => 'animated fadeIn']);?>
				...
				<div class="row p-t-10 m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
				  <div class="control-group  col-md-10">
					<div class="checkbox checkbox check-success"> <a href="/admin/Home/forgot_password">Forgot password?</a>
					</div>
				  </div>
				  </div>
        <?php echo form_close(); ?>
